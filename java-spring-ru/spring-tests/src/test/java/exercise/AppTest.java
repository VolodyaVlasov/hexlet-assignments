...
public class AppTest {
    ...
    void testGetById() throws Exception {
        MockHttpServletResponse getByIdResponse = mockMvc.perform(get("/people/1"))
                .andReturn()
                .getResponse();
        assertThat(getByIdResponse.getStatus()).isEqualTo(200);
        assertThat(getByIdResponse.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        assertThat(getByIdResponse.getContentAsString()).contains("John", "Smith");
    }

    @Test
    void testUpdatePerson() throws Exception {
        MockHttpServletResponse patchResponse = mockMvc.perform(patch("/people/1")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"firstName\": \"name\", \"lastName\": \"lastName\"}"))
                .andReturn()
                .getResponse();

        assertThat(patchResponse.getStatus()).isEqualTo(200);

        MockHttpServletResponse getAllResponse = mockMvc.perform(get("/people"))
                .andReturn()
                .getResponse();

        assertThat(getAllResponse.getContentAsString()).contains("name", "lastName");
    ...
    void testDelete() throws Exception  {
        ...
        MockHttpServletResponse getResponse = mockMvc.perform(get("/people"))
                .andReturn()
                .getResponse();
